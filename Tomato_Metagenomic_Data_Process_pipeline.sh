...
# 三、De novo Metagenomic Pipeline (MEGAHIT)
...
###Fan7h_S33_L007_R1_001_kneaddata_paired_1.fastq
...
https://shengxin.ren/article/215
http://www.jinciwei.cn/b364284.html
...
### salmon
    ...
    # temp/eggnog/protein.emapper.seed_orthologs
    #           temp/eggnog/output.emapper.annotations
    #           temp/eggnog/output
    
    # result/eggnog/cogtab.count
    #            result/eggnog/cogtab.count.spf (STAMP)
    
    # result/eggnog/kotab.count
    #           result/eggnog/kotab.count.spf  (STAMP)
    
    # result/dbcan2/cazytab.count
    #                           result/dbcan2/cazytab.count.spf (用于STAMP)
    
    # result/resfam/resfam.count
    #             result/resfam/resfam.count.spf (STAMP)
